...
CPU_Type=--cpu-type=ArmTimingSimpleCPU

LOG_DATA_DIR=/home/vmuser/gem5/logs
INPUT_DATA_DIR=/home/vmuser/cpu2006/data
BINARY_DIR=/home/vmuser/cpu2006/binaries
GEM5_ROOT=/home/vmuser/gem5

MAX_INST=--maxinsts=3000000
...
runProgran () {
	progress&
	{
		...
		$GEM5_ROOT/build/ARM/gem5.opt --stats-file="$LOG_DATA_DIR/$1" \
		$GEM5_ROOT/configs/example/se.py $CPU_Type $FF $MAX_INST $CACHE $L2 \
...
progress&
{
	$GEM5_ROOT/build/ARM/gem5.opt --stats-file="$LOG_DATA_DIR/log_400.perlbench.txt" \
		$GEM5_ROOT/configs/example/se.py $CPU_Type $FF $MAX_INST $CACHE $L2 \
		$L1D_SIZE $L1I_SIZE $L1I_ASSOC $L1D_ASSOC $LINE_SIZE $L2_SIZE \
...
progress&
{
	$GEM5_ROOT/build/ARM/gem5.opt --stats-file="$LOG_DATA_DIR/log_401.bzip2.txt" \
		$GEM5_ROOT/configs/example/se.py $CPU_Type $FF $MAX_INST $CACHE $L2 \
		$L1D_SIZE $L1I_SIZE $L1I_ASSOC $L1D_ASSOC $LINE_SIZE $L2_SIZE \
		\-c $BINARY_DIR/bzip2 \
...
progress&
{
	$GEM5_ROOT/build/ARM/gem5.opt --stats-file="$LOG_DATA_DIR/log_410.bwaves.txt" \
		$GEM5_ROOT/configs/example/se.py $CPU_Type $FF $MAX_INST $CACHE $L2 \
		$L1D_SIZE $L1I_SIZE $L1I_ASSOC $L1D_ASSOC $LINE_SIZE $L2_SIZE \
...
progress&
{
	$GEM5_ROOT/build/ARM/gem5.opt --stats-file="$LOG_DATA_DIR/log_429.mcf.txt" \
		$GEM5_ROOT/configs/example/se.py $CPU_Type $FF $MAX_INST $CACHE $L2 \
		$L1D_SIZE $L1I_SIZE $L1I_ASSOC $L1D_ASSOC $LINE_SIZE $L2_SIZE \
...
progress&
{
	$GEM5_ROOT/build/ARM/gem5.opt --stats-file="$LOG_DATA_DIR/log_436.cactusADM.txt" \
		$GEM5_ROOT/configs/example/se.py $CPU_Type $FF $MAX_INST $CACHE $L2 \
		$L1D_SIZE $L1I_SIZE $L1I_ASSOC $L1D_ASSOC $LINE_SIZE $L2_SIZE \
...
progress&
{
	$GEM5_ROOT/build/ARM/gem5.opt --stats-file="$LOG_DATA_DIR/log_444.namd.txt" \
		$GEM5_ROOT/configs/example/se.py $CPU_Type $FF $MAX_INST $CACHE $L2 \
		$L1D_SIZE $L1I_SIZE $L1I_ASSOC $L1D_ASSOC $LINE_SIZE $L2_SIZE \
		\-c $BINARY_DIR/namd \
...
# 	$GEM5_ROOT/configs/example/se.py $CPU_Type \
